    ...
    <React.Fragment>
      ...
      <Container>
        <Row>
              ...
              <Row>
                ...
                <Form>
                  ...
                  >
                                    ...
                                    {["checkbox"].map((type) => (
                                      ...
                                      >
                                        <Form.Check
                                          type={type}
                                          id={`default-${type}`}
                                          label="Internet Access Wifi Charges Apply
                            "
                                        />
                                      </div>
                                    ))}
                                    ...
                                    {["checkbox"].map((type) => (
                                      ...
                                      >
                                        <Form.Check
                                          type={type}
                                          id={`default-${type}`}
                                          label="Internet Access Lan Charges Apply
                            "
                                        />
                                      </div>
                                    ))}
                                    ...
                                    {["checkbox"].map((type) => (
                                      ...
                                      >
                                        <Form.Check
                                          type={type}
                                          id={`default-${type}`}
                                          label="Internet Access Wifi Complimentary
                            "
                                        />
                                      </div>
                                    ))}
                    ...
                    <tr>
                      <td>Room Configuration & Access</td>
                      <td>
                        <span>
                          Choose facilities
                          <hr />
                                  ...
                                  {["checkbox"].map((type) => (
                                    ...
                                    >
                                      <Form.Check
                                        type={type}
                                        id={`default-${type}`}
                                        label="Restaurant For Breakfast
                            "
                                      />
                                    </div>
                                  ))}
          ...
          <Col xs={3}>
            <tr>
              <span className="c-text css-54o0zs">
                <b>ROOMS</b>
              </span>
            </tr>
            <tr>
              <ul>
                <li className="css-kd3lya">sweet</li>
              </ul>
            </tr>
          </Col>
        </Row>
