...
import RoomFaclity from "../component/RoomFaclity";
import Photo from "../component/Photo";
import Payment from "../component/Payment";
import Review from "../component/Review";
import Agreement from "../component/Agreement";
import Contract2 from "../component/Contract2";
import UnderReview from "../component/UnderReview";
            ...
            <Row>
              ...
              <Form>
                <Table borderless responsive>
                  ...
                  <tr>
                    <td>Does This Property Have Different Name Previously?</td>
                    <td>
                      {["radio"].map((type) => (
                      ...
                      {["radio"].map((type) => (
                        <div key={`inline-${type}`} className="mb-3">
                            ...
                            <Form.Group>
                              ...
                              <tr>
                                <Form.Text className="text-muted">
                                  Establishment that provides accommodations,
                                  meals, and other services for paying guests
                                  (travellers, tourists)
                                </Form.Text>
                              </tr>
                            </Form.Group>
                          ...
                          <tr>
                            ...
                            <tr>
                              <Form.Text className="text-muted">
                                Budget accommodation (usually shared-room type)
                                rent by individual travellers (backpackers) or
                                groups
                              </Form.Text>
                            </tr>
                          </tr>
                          <tr>
                            ...
                            <tr>
                              <Form.Text className="text-muted">
                                Furnished country house located in countryside
                                area that is often rented for vacation purpose
                              </Form.Text>
                            </tr>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <tr>
                              <Form.Text className="text-muted">
                                Serviced apartment complex with hotel-style
                                booking system that enables travellers to stay
                          ...
                          <tr>
                            ...
                            <tr>
                              <Form.Text className="text-muted">
                                An establishment that offers a spare room in
                                private accommodation (e.g. private house,
                                boarding house). It also provides breakfast
                              </Form.Text>
                            </tr>
                          </tr>
                          <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Group className="mb-3" controlId="formName">
                        ...
                        <Form.Control type="text" placeholder="room" readOnly />
                      </Form.Group>
                    </td>
                  </tr>
                  <tr>
                    <td>Does This Property Use Channel Manager System?</td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Table borderless responsive>
                        ...
                        <tr>
                          <p>
                            Main Contact will be contacted for any inquiries
                            regarding reservation, finance, and
                            payment/accounting.
                          </p>
                        </tr>
                        <tr>
                          <p>
                            If those fields were managed by different person,
        ...
        <Row align="right">
          <div align="right">
            <Button variant="outline-dark" size="lg">
              Save and countneu to next section
            </Button>
          </div>
        </Row>
        <Row>
